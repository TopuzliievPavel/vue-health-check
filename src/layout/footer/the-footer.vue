      ...
      <div class="footer__inner border--top">
        ...
        <ul class="footer__list order-negative-medium flex-grow-1-medium">
          <li class="footer__item">
            <button class="btn-privacy btn-reset font-weight-semi btn-privacy-js" type="button">Terms and Conditions</button>
          </li>
          <li class="footer__item">
            <button class="btn-privacy btn-reset font-weight-semi btn-privacy-js" type="button">Privacy Policy</button>
          </li>
        </ul>
...
<script>
  import TheFooterDropdown from '@/layout/footer/footer-dropdown/the-footer-dropdown.vue'
  export default {
    name: 'TheFooter',
    components: {
      TheFooterDropdown
